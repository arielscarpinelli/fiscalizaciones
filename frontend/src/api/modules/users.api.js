import apiClient, { refreshClient } from "api/apiClient";

export const login = (data) => refreshClient.post("auth/login", data);
...
export const checkToken = () => refreshClient.post("users/check-token-validity");
